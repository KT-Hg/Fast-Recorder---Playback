...
const VI = {
  ...
  'redo.title': 'Xem trước SQL làm lại',
  'redo.againTitle': 'Áp dụng lại một lần nữa',
  'redo.nothing': 'Không có gì để làm lại.',
  'redo.blocked': '{n} thay đổi không tự làm lại được và đã bị bỏ qua.',
  'redo.note': 'Chạy lại đúng các thay đổi đã rollback, theo thứ tự lúc đầu.',
  'redo.againNote': 'Các thay đổi này vẫn đang áp dụng — chạy sẽ ghi lại đúng các giá trị mới đó một lần nữa.',
  'redo.update': 'đặt lại {n} dòng',
  'redo.delete': 'xoá lại {n} dòng',
  'redo.insert': 'chèn lại {n} dòng',
  'panel.redoAll': '↷ Làm lại',
  'panel.redoAllHint': 'Áp dụng lại các thay đổi đã rollback',
  'mgr.redoOne': '↷',
  'mgr.redoOneHint': 'Áp dụng lại riêng thay đổi này',
  'mgr.redoSelected': '↷ Làm lại mục đã chọn',
  'mgr.redoN': '↷ Làm lại {n} mục đã chọn',
  'mgr.redoAllN': '↷ Làm lại tất cả ({n})',
  ...
  'reason.redo-no-after': 'không ghi lại giá trị mới — chạy lại câu lệnh gốc để làm lại',
...
const EN = {
  ...
  'redo.title': 'Re-apply preview',
  'redo.againTitle': 'Apply these changes once more',
  'redo.nothing': 'Nothing to re-apply.',
  'redo.blocked': '{n} change(s) cannot be applied again automatically and were skipped.',
  'redo.note': 'Runs the rolled-back changes again, in the order they were made.',
  'redo.againNote': 'These changes are still applied — running this writes those same new values once more.',
  'redo.update': 'set {n} row(s) again',
  'redo.delete': 'delete {n} row(s) again',
  'redo.insert': 're-insert {n} row(s)',
  'panel.redoAll': '↷ Re-apply',
  'panel.redoAllHint': 'Apply the rolled-back changes again',
  'mgr.redoOne': '↷',
  'mgr.redoOneHint': 'Apply just this change again',
  'mgr.redoSelected': '↷ Re-apply selected',
  'mgr.redoN': '↷ Re-apply {n} selected',
  'mgr.redoAllN': '↷ Re-apply all {n}',
  ...
  'reason.redo-no-after': 'the new values were not recorded — run the original statement again to repeat it',
